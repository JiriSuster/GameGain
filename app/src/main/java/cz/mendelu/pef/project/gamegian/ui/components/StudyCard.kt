...
@Composable
fun StudyCard(hours: String, minutes: String, time: Long) {
    Row {
        // Checkbox
        ...
        // Content column
        Column {
            Text(text = "studying ${hours}h ${minutes}m")
...
fun StudyCardPreview() {
    ...
    StudyCard("1", "30", 5400000L) // Example values: 1 hour 30 minutes = 5400000 milliseconds
}
